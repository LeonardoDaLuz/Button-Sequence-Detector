...
namespace LeoLuz.Utilities
{
    ...
    public class DGUI : MonoBehaviour
    {
        ...
        public static void BeginVerticalStylized(string themeName = "")
        {
            ...
            {
                if (InspectorBeautifierExtensions.InterfaceThemeConfig == null)
                {
                    InspectorBeautifierExtensions.InterfaceThemeConfig = FileUtility.LoadFile(InspectorBeautifierExtensions.ThemeFileName) as ComboMasterInterfaceConfig;
                }
                defaultTheme = themeName == "" ? InspectorBeautifierExtensions.InterfaceThemeConfig.CustomStyles[0] : InspectorBeautifierExtensions.InterfaceThemeConfig.GetCustomStyle(themeName);
            }
